...
[Get Postman Collection](http://localhost/pos48/public/docs/collection.json)
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/get-attendance/1" \
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/get-attendance/1"
);
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/clock-in" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"sed","ip_address":"neque","latitude":"dolore","longitude":"eaque"}'
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/clock-out" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"voluptatibus","latitude":"laborum","longitude":"commodi"}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/holidays?location_id=1&start_date=2020-06-25&end_date=2020-06-25" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/holidays"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/brand" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/brand"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/brand/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/brand/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/business-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/business-location"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/business-location/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/business-location/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=accusantium&follow_up_type=eum&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/crm/follow-ups"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/crm/follow-ups/1,2" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/crm/follow-ups/1,2"
);
...
```bash
curl -X PUT \
    "http://localhost/pos48/public/connector/api/crm/follow-ups/20" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"et","schedule_type":"sit","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","followup_additional_info":"['call duration' => '1 hour']","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/crm/follow-up-resources" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/crm/follow-up-resources"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=natus&biz_name=quas&mobile_num=20&contact_id=eligendi&order_by=quas&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/crm/leads"
);
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/crm/call-logs" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"cupiditate","mobile_name":"adipisci","call_type":"call","start_time":"minus","end_time":"repellat","duration":"delectus"}]}'
...
let body = {
    "call_logs": [
        {
            "mobile_number": "cupiditate",
            "mobile_name": "adipisci",
            "call_type": "call",
            "start_time": "minus",
            "end_time": "repellat",
            "duration": "delectus"
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/cash-register?status=open&user_id=10&start_date=2018-06-25&end_date=2018-06-25&location_id=1&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/cash-register"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":641,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":126.18,"total_card_slips":16,"total_cheques":12,"closing_note":"voluptas","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/cash-register/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/cash-register/59"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/contactapi?type=eum&name=architecto&biz_name=est&mobile_num=3&contact_id=sit&order_by=impedit&direction=et&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/contactapi"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"et","prefix":"corporis","first_name":"officia","middle_name":"temporibus","last_name":"a","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"deleniti","address_line_2":"quia","city":"cupiditate","state":"enim","country":"et","zip_code":"accusamus","customer_group_id":"natus","contact_id":"quia","dob":"2000-06-13","custom_field1":"quidem","custom_field2":"quia","custom_field3":"recusandae","custom_field4":"ratione","email":"et","shipping_address":"at","position":"cumque","opening_balance":0,"source_id":9,"life_stage_id":4,"assigned_to":[]}'
...
let body = {
    ...
    "contact_id": "quia",
    "dob": "2000-06-13",
    "custom_field1": "quidem",
    "custom_field2": "quia",
    "custom_field3": "recusandae",
    "custom_field4": "ratione",
    "email": "et",
    "shipping_address": "at",
    "position": "cumque",
    "opening_balance": 0,
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/contactapi/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/contactapi/1"
);
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"necessitatibus","prefix":"est","first_name":"tenetur","middle_name":"nobis","last_name":"in","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"molestiae","address_line_2":"ex","city":"a","state":"molestias","country":"error","zip_code":"culpa","customer_group_id":"neque","contact_id":"aut","dob":"2000-06-13","custom_field1":"doloremque","custom_field2":"pariatur","custom_field3":"ipsa","custom_field4":"enim","email":"quidem","shipping_address":"placeat","position":"culpa","opening_balance":10.3,"source_id":19,"life_stage_id":8,"assigned_to":[]}'
...
let body = {
    "type": "customer",
    "supplier_business_name": "necessitatibus",
    "prefix": "est",
    "first_name": "tenetur",
    "middle_name": "nobis",
    "last_name": "in",
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/contactapi-payment" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":15,"card_number":"est","card_holder_name":"consequuntur","card_transaction_number":"nihil","card_type":"ut","card_month":"qui","card_year":"omnis","card_security":"quis","transaction_no_1":"libero","transaction_no_2":"nisi","transaction_no_3":"odio","cheque_number":"similique","bank_account_number":"suscipit","note":"et"}'
...
let body = {
    ...
    "account_id": 15,
    "card_number": "est",
    "card_holder_name": "consequuntur",
    "card_transaction_number": "nihil",
    "card_type": "ut",
    "card_month": "qui",
    "card_year": "omnis",
    "card_security": "quis",
    "transaction_no_1": "libero",
    "transaction_no_2": "nisi",
    "transaction_no_3": "odio",
    "cheque_number": "similique",
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=eligendi&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/expense"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":31028553.186,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":20,"expense_for":6,"contact_id":2,"expense_category_id":20,"expense_sub_category_id":9,"additional_notes":"expedita","is_refund":0,"is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"nulla","recur_repetitions":11,"payment":[{"amount":453.13,"method":"cash","account_id":17,"card_number":"aliquid","card_holder_name":"corporis","card_transaction_number":"suscipit","card_type":"sit","card_month":"suscipit","card_year":"aut","card_security":"rem","transaction_no_1":"ipsam","transaction_no_2":"et","transaction_no_3":"atque","note":"quo","cheque_number":"repellat"}]}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "http://localhost/pos48/public/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":98.777658,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":6,"expense_for":15,"contact_id":9,"expense_category_id":17,"expense_sub_category_id":20,"additional_notes":"commodi","is_recurring":0,"recur_interval":13,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"accusamus","recur_repetitions":13,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=expedita&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/expense-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/expense-categories"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/field-force?contact_id=nostrum&assigned_to=sapiente&status=omnis&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/field-force"
);

let params = {
    "contact_id": "nostrum",
    "assigned_to": "sapiente",
    "status": "omnis",
    "start_date": "2018-06-25",
    "end_date": "2018-06-25",
    "per_page": "15",
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/field-force/create" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":16,"visit_to":"in","visit_address":"optio","assigned_to":7,"visit_on":"2021-12-28 17:23:00","visit_for":"rerum"}'
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/field-force/update-visit-status/17" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"officia","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"expedita","photo":"modi"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "officia",
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/product?order_by=quis&order_direction=mollitia&brand_id=quis&category_id=ut&sub_category_id=vero&location_id=1&selling_price_group=rerum&send_lot_detail=ex&name=omnis&sku=facilis&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/product"
);

let params = {
    "order_by": "quis",
    "order_direction": "mollitia",
    "brand_id": "quis",
    "category_id": "ut",
    "sub_category_id": "vero",
    "location_id": "1",
    "selling_price_group": "rerum",
    "send_lot_detail": "ex",
    "name": "omnis",
    "sku": "facilis",
    "per_page": "10",
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/product/1?selling_price_group=totam&send_lot_detail=odit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/product/1"
);

let params = {
    "selling_price_group": "totam",
    "send_lot_detail": "odit",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/variation/2?product_id=eum&location_id=1&brand_id=ea&category_id=corporis&sub_category_id=dignissimos&not_for_selling=nam&name=at&sku=sunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/variation/2"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/sell?location_id=1&contact_id=aperiam&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=omnis&service_staff_id=odio&shipping_status=ordered&source=non&only_subscriptions=est&send_purchase_details=atque&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/sell"
);
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":11,"transaction_date":"2020-07-22 15:48:29","invoice_no":"officiis","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":7,"discount_amount":10,"discount_type":"fixed","sale_note":"aliquam","staff_note":"dignissimos","commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"itaque","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":19,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":6,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"nemo","recur_repetitions":10,"rp_redeemed":9,"rp_redeemed_amount":13.5,"types_of_service_id":4,"service_custom_field_1":"nemo","service_custom_field_2":"quo","service_custom_field_3":"earum","service_custom_field_4":"repudiandae","service_custom_field_5":"omnis","service_custom_field_6":"porro","round_off_amount":440717.5,"table_id":20,"service_staff_id":4,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":3,"note":"placeat"}],"payments":[{"amount":453.13,"method":"cash","account_id":6,"card_number":"animi","card_holder_name":"animi","card_transaction_number":"explicabo","card_type":"nobis","card_month":"ut","card_year":"eveniet","card_security":"qui","transaction_no_1":"consequuntur","transaction_no_2":"maxime","transaction_no_3":"rerum","bank_account_number":"voluptatem","note":"molestiae","cheque_number":"omnis"}]}]}'
    ...
    "sells": [
        {
            ...
            "discount_type": "fixed",
            "sale_note": "aliquam",
            "staff_note": "dignissimos",
            "commission_agent": 19,
            "shipping_details": "Express Delivery",
            "shipping_address": "itaque",
            "shipping_status": "ordered",
            ...
            "service_custom_field_1": "nemo",
            "service_custom_field_2": "quo",
            "service_custom_field_3": "earum",
            "service_custom_field_4": "repudiandae",
            "service_custom_field_5": "omnis",
            "service_custom_field_6": "porro",
            "round_off_amount": 440717.5,
            "table_id": 20,
            "service_staff_id": 4,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_transaction_number": "explicabo",
                    "card_type": "nobis",
                    "card_month": "ut",
                    "card_year": "eveniet",
                    "card_security": "qui",
                    "transaction_no_1": "consequuntur",
                    "transaction_no_2": "maxime",
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/sell/55?send_purchase_details=rem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "http://localhost/pos48/public/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":8,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":10,"discount_amount":10,"discount_type":"fixed","sale_note":"suscipit","source":"excepturi","staff_note":"dignissimos","is_suspend":false,"commission_agent":13,"shipping_details":"Express Delivery","shipping_address":"reprehenderit","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":3,"pay_term_number":19,"pay_term_type":"months","is_recurring":0,"recur_interval":9,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"incidunt","recur_repetitions":6,"rp_redeemed":7,"rp_redeemed_amount":13.5,"types_of_service_id":7,"service_custom_field_1":"voluptatibus","service_custom_field_2":"quisquam","service_custom_field_3":"tempora","service_custom_field_4":"et","service_custom_field_5":"eum","service_custom_field_6":"cumque","round_off_amount":4839.83456588,"table_id":8,"service_staff_id":18,"change_return":0,"change_return_id":13,"products":[{"sell_line_id":8,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":13,"discount_amount":0,"discount_type":"percentage","sub_unit_id":7,"note":"quae"}],"payments":[{"payment_id":18,"amount":453.13,"method":"cash","account_id":13,"card_number":"tenetur","card_holder_name":"harum","card_transaction_number":"beatae","card_type":"architecto","card_month":"corrupti","card_year":"nisi","card_security":"est","transaction_no_1":"asperiores","transaction_no_2":"nam","transaction_no_3":"minus","note":"eum","cheque_number":"quo","bank_account_number":"quia"}]}'
...
let body = {
    ...
    "commission_agent": 13,
    "shipping_details": "Express Delivery",
    "shipping_address": "reprehenderit",
    "shipping_status": "ordered",
    "delivered_to": "Mr Robin",
    "shipping_charges": 10,
    "packing_charge": 10,
    ...
    "subscription_no": "incidunt",
    "recur_repetitions": 6,
    "rp_redeemed": 7,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 7,
    "service_custom_field_1": "voluptatibus",
    "service_custom_field_2": "quisquam",
    "service_custom_field_3": "tempora",
    "service_custom_field_4": "et",
    "service_custom_field_5": "eum",
    "service_custom_field_6": "cumque",
    "round_off_amount": 4839.83456588,
    "table_id": 8,
    "service_staff_id": 18,
    "change_return": 0,
    "change_return_id": 13,
    ...
    "payments": [
        {
            ...
            "account_id": 13,
            "card_number": "tenetur",
            "card_holder_name": "harum",
            "card_transaction_number": "beatae",
            "card_type": "architecto",
            "card_month": "corrupti",
            "card_year": "nisi",
            "card_security": "est",
            "transaction_no_1": "asperiores",
            "transaction_no_2": "nam",
            "transaction_no_3": "minus",
            "note": "eum",
            "cheque_number": "quo",
            "bank_account_number": "quia"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost/pos48/public/connector/api/sell/sed" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":17,"transaction_date":"2020-5-7 15:20:22","invoice_no":"eos","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":12,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":12,"shipping_status":"ordered","delivered_to":"omnis"}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/table?location_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/table"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/taxonomy?type=et" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/user/loggedin"
);
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/user-registration" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"aperiam","first_name":"libero","last_name":"nesciunt","email":"praesentium","is_active":"aspernatur","user_type":"repellendus","crm_contact_id":16,"allow_login":true,"username":"adipisci","password":"nostrum","role":12,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"tempore","max_sales_discount_percent":"aut","selected_contacts":true,"selected_contact_ids":[],"dob":"odio","gender":"ipsum","marital_status":"tenetur","blood_group":"qui","contact_number":"iste","alt_number":"dignissimos","family_number":"reprehenderit","fb_link":"nihil","twitter_link":"aspernatur","social_media_1":"laudantium","social_media_2":"aut","custom_field_1":"molestiae","custom_field_2":"non","custom_field_3":"velit","custom_field_4":"doloribus","guardian_name":"odio","id_proof_name":"quo","id_proof_number":"omnis","permanent_address":"dolor","current_address":"qui","bank_details":[{"account_holder_name":"itaque","account_number":"temporibus","bank_name":"placeat","bank_code":"error","branch":"debitis","tax_payer_id":"doloremque"}]}'
...
let body = {
    ...
    "max_sales_discount_percent": "aut",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "odio",
    "gender": "ipsum",
    "marital_status": "tenetur",
    "blood_group": "qui",
    "contact_number": "iste",
    "alt_number": "dignissimos",
    "family_number": "reprehenderit",
    "fb_link": "nihil",
    "twitter_link": "aspernatur",
    "social_media_1": "laudantium",
    "social_media_2": "aut",
    "custom_field_1": "molestiae",
    "custom_field_2": "non",
    "custom_field_3": "velit",
    "custom_field_4": "doloribus",
    "guardian_name": "odio",
    "id_proof_name": "quo",
    "id_proof_number": "omnis",
    "permanent_address": "dolor",
    "current_address": "qui",
    "bank_details": [
        {
            "account_holder_name": "itaque",
            "account_number": "temporibus",
            "bank_name": "placeat",
            "bank_code": "error",
            "branch": "debitis",
            "tax_payer_id": "doloremque"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/user?service_staff=ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/user"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/user/1"
);
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"eum","new_password":"animi"}'
...
```bash
curl -X POST \
    "http://localhost/pos48/public/connector/api/forget-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"email":"quis"}'
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/profit-loss-report?location_id=1&start_date=2018-06-25&end_date=2018-06-25&user_id=1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/notifications"
);
...
```bash
curl -X GET \
    -G "http://localhost/pos48/public/connector/api/get-location" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
...
```javascript
const url = new URL(
    "http://localhost/pos48/public/connector/api/get-location"
);
