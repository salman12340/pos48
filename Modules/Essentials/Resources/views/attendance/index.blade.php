                            ...
                            <table class="table table-bordered table-striped" id="attendance_table" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('essentials::lang.clock_in_meter')</th>
                                        <th>@lang('essentials::lang.clock_out_meter')</th>
        ...
        $(document).ready(function() {
            attendance_table = $('#attendance_table').DataTable({
                ...
                columns: [
                    ...
                    { data: 'clock_in_meter', name: 'clock_in_meter', orderable: false, searchable: false},
                    { data: 'clock_out_meter', name: 'clock_out_meter', orderable: false, searchable: false},
