    ...
    <div class="modal-body">
    	<div class="row">
            ...
            <div class="form-group col-md-12">
              ...
              {!! Form::text('clock_in_meter', $attendance->clock_in_meter, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_in_meter'), 'rows' => 3 ]); !!}
            </div>
            <div class="form-group col-md-12">
              {!! Form::label('clock_out_meter', __( 'essentials::lang.clock_out_meter' ) . ':') !!}
              {!! Form::text('clock_out_meter', $attendance->clock_out_meter, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_out_meter'), 'rows' => 3 ]); !!}
            </div>
    	</div>
    </div>
