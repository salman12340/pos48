<tr data-user_id="{{$user->id}}">
	...
	<td>
		{!! Form::text('attendance[' . $user->id . '][clock_in_meter]', !empty($attendance->clock_in_meter) ? $attendance->clock_in_meter : null, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_in_meter'), 'rows' => 3 ]); !!}
	</td>
	<td>
		{!! Form::text('attendance[' . $user->id . '][clock_out_meter]', !empty($attendance->clock_out_meter) ? $attendance->clock_out_meter : null, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_out_meter'), 'rows' => 3 ]); !!}
	</td>
