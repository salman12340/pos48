<div class="modal fade" id="clock_in_clock_out_modal" tabindex="-1" role="dialog" 
    ...
    <div class="modal-dialog" role="document">
	  <div class="modal-content">
	    ...
	    {!! Form::open(['url' => action('\Modules\Essentials\Http\Controllers\AttendanceController@clockInClockOut'), 'method' => 'post', 'id' => 'clock_in_clock_out_form','files' => true ]) !!}
	    	...
	    	<div class="row">
	    		<input type="hidden" name="type" id="type">
		      	...
		      	<div class="form-group col-md-12 clock_in_note @if(!empty($clock_in)) hide @endif">
		        	...
		        	{!! Form::label('clock_in_meter', __( 'essentials::lang.clock_in_meter' ) . ':') !!}
		        	{!! Form::text('clock_in_meter', null, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_in_meter'), 'rows' => 1 ]); !!}
		        	{!! Form::label('meter', __('purchase.attach_document') . ':') !!}
                    {!! Form::file('meter', ['id' => 'upload_document', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
		      	</div>
		      	<div class="form-group col-md-12 clock_out_note @if(empty($clock_in)) hide @endif">
		        	...
		        	{!! Form::label('clock_out_meter', __( 'essentials::lang.clock_out_meter' ) . ':') !!}
		        	{!! Form::text('clock_out_meter', null, ['class' => 'form-control', 'placeholder' => __( 'essentials::lang.clock_out_meter'), 'rows' => 1 ]); !!}
		        	{!! Form::label('meter', __('purchase.attach_document') . ':') !!}
                    {!! Form::file('meter', ['id' => 'upload_document', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
		      	</div>
